...
with open(dataDir + 'teamIDs.txt', 'r') as f:
    ids = [line.strip() for line in f]
    for line in ids:
        address = ('http://www.cfbstats.com/' + year + '/team/' + line + '/rushing/index.html')
        response = requests.get(address)
        html = response.content
        ...
        for row in alltr[1:]:
            ...
            list_of_cells.append(line)
            list_of_rows.append(list_of_cells)
        outfile = open(dataDir + year + 'rushing.csv', 'a', newline='\n')
        writer = csv.writer(outfile,delimiter='|')
        writer.writerows(list_of_rows)
        outfile.close()

csv_input = pd.read_csv(dataDir + year + 'rushing.csv',sep='|')
csv_input['Year'] = year
csv_input.to_csv(dataDir + year + 'rushing.csv', index=False, sep='|')
...
with open(dataDir + 'teamIDs.txt', 'r') as f:
    ids = [line.strip() for line in f]
    for line in ids:
        address = ('http://www.cfbstats.com/' + year + '/team/' + line + '/puntreturn/index.html')
        response = requests.get(address)
        html = response.content
        ...
        for row in alltr[1:]:
            ...
            list_of_cells.append(line)
            list_of_rows.append(list_of_cells)
        outfile = open(dataDir + year + 'puntReturn.csv', 'a', newline='\n')
        writer = csv.writer(outfile,delimiter='|')
        writer.writerows(list_of_rows)
        outfile.close()

csv_input = pd.read_csv(dataDir + year + 'puntReturn.csv',sep='|')
csv_input['Year'] = year
csv_input.to_csv(dataDir + year + 'puntReturn.csv', index=False, sep='|')
...
with open(dataDir + 'teamIDs.txt', 'r') as f:
    ids = [line.strip() for line in f]
    for line in ids:
        address = ('http://www.cfbstats.com/' + year + '/team/' + line + '/kickreturn/index.html')
        response = requests.get(address)
        html = response.content
        ...
        for row in alltr[1:]:
            ...
            list_of_cells.append(line)
            list_of_rows.append(list_of_cells)
        outfile = open(dataDir + year + 'kickReturn.csv', 'a', newline='\n')
        writer = csv.writer(outfile,delimiter='|')
        writer.writerows(list_of_rows)
        outfile.close()

csv_input = pd.read_csv(dataDir + year + 'kickReturn.csv',sep='|')
csv_input['Year'] = year
csv_input.to_csv(dataDir + year + 'kickReturn.csv', index=False, sep='|')
